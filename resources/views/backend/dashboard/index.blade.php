...
<script>
    var saleMonthlyCounts = @json($sale_count); // Assuming $sale_count is an array passed from the controller
    var userMonthlyCounts = @json($user_count);
    var homeMonthlyCounts = @json($home_count);
