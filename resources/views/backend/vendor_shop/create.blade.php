            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <form class="row themeform" method="post" action="{{ route('vendor_shop.store') }}" enctype="multipart/form-data" id="package_form">
                            @csrf

                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="shop_name">Name Of Shop:</label>
                                    <input class="form-control" id="shop_name" type="text" placeholder="Enter Name of Shop" name="shop_name" value="{{ old('shop_name') }}">
