...
@section('title', 'Edit Vendor shop')
...
@section('breadcrumb-items')
    ...
    <a href="{{ route('vendor_shop.index') }}" class="breadcrumb-item">Vendor Shop Details</a>
                ...
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <form class="row needs-validation themeform" method="post"
                            action="{{ Route('vendor_shop.update', $VendorShop->id) }}" enctype="multipart/form-data"
                            id="package_form">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="shop_name" type="text"
                                        ...
                                        value="{{ old('shop_name', $VendorShop->shop_name) }}">
                                    ...
                                    <select name="category" id="category" class="form-control">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ (old('category', $VendorShop->category_id) == $category->id) ? 'selected' : '' }}>
                                    ...
                                    <select name="vendor" id="vendor" class="form-control">
                                        ...
                                        @foreach ($vendors as $vendor)
                                            <option value="{{ $vendor->id }}"
                                                {{ (old('vendor', $VendorShop->vendor_id) == $vendor->id) ? 'selected' : '' }}>
                                                {{ $vendor->name }} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="phone" type="text"
                                        ...
                                        value="{{ old('phone', $VendorShop->phone) }}">
                                    <span class="text-danger" id="phone-error"></span>
                                </div>
                                <div class="form-group">
                                    <label>Address:</label>
                                    <textarea id="address" name="address" rows="4" placeholder="Enter a Address" class="form-control" required>{{ old('address', $VendorShop->address) }}</textarea>
                                    <span class="text-danger" id="address-error"></span>
                                </div>

                                <div class="form-group">
                                    <label for="description">Description:</label>
                                    <textarea id="description" rows="4" class="form-control" name="description" placeholder="Enter a Description">{!! old('description', $VendorShop->description) !!}</textarea>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    @foreach ($VendorShop->getMedia('logo_image') as $image)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        @foreach ($VendorShop->getMedia('images') as $image)
                                            <div class="d-flex flex-column">
                                                <img src="{{ $image->getUrl() }}" alt="{{ $image->name }}"
                                                    style="height: 100px;width: 100px;">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#form_submit_button').click(function(event) {
                ...
                // Make AJAX request
                $.ajax({
                    url: "{{ route('vendor_shop.update', $VendorShop->id) }}",
                    type: 'POST',
                    data: formData,
                    headers: {
                    ...
                    success: function(data) {
                        ...
                        if (data.success) {
                            window.location = "{{ URL::to('/admin/vendor_shop') }}";
                        }
                    },
