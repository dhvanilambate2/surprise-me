...
@section('title', 'Edit Home For Rent')
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <form class="row needs-validation themeform" method="post" action="{{ Route('home_for_rent.update',$homeDetails->id) }}" enctype="multipart/form-data" id="package_form">
                            @csrf
                            @method('PUT')
