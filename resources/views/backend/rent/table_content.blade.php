            ...
            @foreach ($homeDetails as $item)
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <input class="current-project-checkbox" onchange="updateCurrentProject(this, {{ $item->id }}, this.checked)" id="{{ $item->id }}"  type="checkbox" {{ ($item->current_project == '1')? "checked" : '' }}>
                    </td>
                    @endif

                    <td class="text-nowrap">
                            <a href="{{ route('home_for_rent.details', ['id' => $item->id]) }}" target="_blank"><button class="btn btn-shadow-secondary btn-sm px-3">Preview </button></a>
                            <a href="{{ route('home_for_rent.edit', $item->id) }}"><button class="btn btn-shadow-primary btn-sm">Edit </button></a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('home_for_rent.destroy', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
