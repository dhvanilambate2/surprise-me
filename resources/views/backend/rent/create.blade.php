...
@section('title', 'Add Home Listing')
...
@section('breadcrumb-items')
    ...
    <a href="{{ route('home_for_rent.index') }}" class="breadcrumb-item">Manage Homes</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="badrooms" type="number" placeholder="Enter Bedrooms" name="badrooms" value="{{ old('badrooms') }}">
                                    ...
                                    <div class="col-md-4 col-sm-6 d-flex">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <input class="form-control" id="price" type="text" name="sqft_width" value="{{ old('sqft_width') }}">
