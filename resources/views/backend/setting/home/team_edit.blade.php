            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        @endif
                        <form class="row needs-validation themeform" method="post" action="{{ route('setting_home.team_update',$teams->id) }}"
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="name" type="text" placeholder="Enter Name"
                                        name="name" value="{{ old('name', $teams->name) }}">
                                    <span class="text-danger" id="name-error"></span>
                                </div>
                                <div class="form-group">
                                    <label for="post">Post</label>
                                    <input class="form-control" id="post" type="text" placeholder="Enter Post"
                                        name="post" value="{{ old('post',$teams->post) }}">
                                    <span class="text-danger" id="post-error"></span>
                                </div>
                                <div class="form-group">
                                    <label for="description">Description:</label>
                                    <textarea id="description" class="rounded" name="description">{{ old('description', $teams->description) }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="facebook" type="url"
                                                ...
                                                value="{{ old('facebook', $teams->facebook) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="twitter" type="url"
                                                ...
                                                value="{{ old('twitter',$teams->twitter) }}">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div id="imagePreviewContainer" >
                                    @if($teams->hasMedia('teams'))
                                        <div class="d-flex mb-3">
                                            @foreach($teams->getMedia('teams') as $image)
    ...
    var images = [];
        ...
        $(document).ready(function() {
            ...
            $('#form_submit_button').click(function (event) {
              ...
              // Make AJAX request
              $.ajax({
                  url: "{{ route('setting_home.team_update', $teams->id) }}",
                  type: 'POST',
                  data: formData,
                  cache: false,
                  contentType: false,
