            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        @endif
                        <form class="row needs-validation themeform" method="post" action="{{ route('setting_home.review_update',$review->id) }}"
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="post" type="text" placeholder="Enter Post"
                                        name="post" value="{{ old('post',$review->post) }}">
                                </div>
                                <div class="form-group">
                                    <label for="description">Description:</label>
                                    <textarea id="description" class="rounded" name="description">{{ old('description', $review->description) }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <label>Image: </label>
                                <div id="imagePreviewContainer">
                                    @if($review->hasMedia('reviews'))
    ...
    var images = [];
        ...
        $(document).ready(function() {
            $('#form_submit_button').click(function (event) {
              ...
              // Make AJAX request
              $.ajax({
                  url: "{{ route('setting_home.review_update', $review->id) }}",
                  type: 'POST',
                  data: formData,
                  cache: false,
                  contentType: false,
