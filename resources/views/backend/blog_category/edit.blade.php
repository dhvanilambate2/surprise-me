...
@section('breadcrumb-title')
	<h2>Blog Categories<span>Edit</span></h2>
@endsection
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        @endif
                        <form class="row needs-validation themeform" method="post" action="{{ route('blog_categories.update', $blog_category->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="name" type="text" placeholder="Enter Category Name" name="name" value="{{ old('name', $blog_category->name) }}">
                                </div>
                            </div>
