                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-nowrap">
                              ...
                              <a href="{{ route('blog_categories.edit', $item->id) }}"><button class="btn btn-shadow-primary btn-sm">Edit </button></a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                       <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                                ...
                                                <form action="{{ route('blog_categories.destroy', $item->id) }}" method="POST">
                                                   @csrf
                                                   @method('DELETE')
