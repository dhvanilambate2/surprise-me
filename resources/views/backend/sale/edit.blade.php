...
@section('breadcrumb-items')
    ...
    <a href="{{route('home_for_rent.index')}}" class="breadcrumb-item">Home For Sale</a> 
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <form class="row needs-validation themeform" method="post" action="{{ Route('home_for_sale.update',$homeDetails->id) }}" enctype="multipart/form-data" id="package_form">
                            @csrf
                            @method('PUT')

                            <div class="col-sm-8">
                                <input type="hidden" value="sale" name="home_for">
                                <input type="hidden" name="status" id="selectedStatus" value="{{ $homeDetails->status }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="bathroom" type="number" placeholder="Enter bathroom" name="bathroom" value="{{ old('bathroom', $homeDetails->bathrooms) }}">
                                    ...
                                    <div class="col-md-4 col-sm-6 d-flex">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <input class="form-control" id="price" type="text" name="sqft_width" value="{{ old('sqft_width', $homeDetails->sqft_width) }}"> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-dropdown custom-dropdown-3">
                                        <input type="hidden" name="home_type" id="selectedHomeType" value="{{ $home_type_value }}">
...
<script>
    ...
    $(document).ready(function() {
      ...
      // Prevent default form submission
          ...
          // Make AJAX request
          $.ajax({
              url: "{{ route('home_for_sale.update',$homeDetails->id) }}",
              type: 'POST',
              data: formData,
              headers: {
