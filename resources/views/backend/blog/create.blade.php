            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        @endif
                        <form class="row needs-validation themeform"  method="post" action="{{ route('blogs.store') }}" enctype="multipart/form-data" id="package_form">
                            @csrf
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="blog_category" id="blog_category" class="form-control" required>
                                        ...
                                        @foreach ($blog_categories as $item)
                                            <option value="{{$item->id}}" {{ (old('blog_category'))? 'selected' : ''}}>{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="content" rows="4" class="form-control" placeholder="Enter a Content" name="content" required>{{ old('content') }}</textarea>
