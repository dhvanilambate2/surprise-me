...
<!-- Start of breadcrumb section
	============================================= -->
	<section id="bi-breadcrumbs" class="bi-bredcrumbs-section position-relative" data-background="{{ asset('assets/surpriseme/category/category_bg.jpg') }}">
...
<!-- Start of Category Feed section
	============================================= -->
				...
				<div class="row justify-content-center ">
					<div class="col-lg-4 col-md-6">
						<div class="bi-service-feed-item position-relative" >
							<span class="hover_img position-absolute" data-background="{{ asset('assets/surpriseme/category/family-gathering.jpg') }}"></span>
							...
							<div class="service-text headline pera-content">
								<h3><a href="#">Family Gatherings</a></h3>
								<p>Surprise family reunion</p>
					...
					<div class="col-lg-4 col-md-6">
						<div class="bi-service-feed-item position-relative" >
							<span class="hover_img position-absolute" data-background="{{ asset('assets/surpriseme/category/workplac-event.jpg') }}"></span>
							<span class="serial-number position-absolute">02</span>
							<div class="service-icon position-relative">
								<i class="flaticon-laptop"></i>
							</div>
							<div class="service-text headline pera-content">
								<h3><a href="#">Workplace Events</a></h3>
								<p>Surprise office party or team-building event</p>
								<a class="read_more d-flex justify-content-center align-items-center text-uppercase" href="#"><i class="fas fa-long-arrow-right"></i></a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6">
						<div class="bi-service-feed-item position-relative" >
							<span class="hover_img position-absolute" data-background="{{ asset('assets/surpriseme/category/birthday.jpg') }}"></span>
					...
					<div class="col-lg-4 col-md-6">
						<div class="bi-service-feed-item position-relative" >
							<span class="hover_img position-absolute" data-background="{{ asset('assets/surpriseme/category/anniversary.jpg') }}"></span>
							<span class="serial-number position-absolute">04</span>
							<div class="service-icon position-relative">
								<i class="flaticon-4k"></i>
							</div>
							<div class="service-text headline pera-content">
								<h3><a href="#">Anniversary</a></h3>
								<p>Timeless Togetherness</p>
								<a class="read_more d-flex justify-content-center align-items-center text-uppercase" href="#"><i class="fas fa-long-arrow-right"></i></a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6">
						<div class="bi-service-feed-item position-relative" >
							<span class="hover_img position-absolute" data-background="{{ asset('assets/surpriseme/category/couple.jpg') }}"></span>
							...
							<div class="service-text headline pera-content">
								...
								<p>Surprise date night (e.g., dinner at a special place)</p>
								<a class="read_more d-flex justify-content-center align-items-center text-uppercase" href="#"><i class="fas fa-long-arrow-right"></i></a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6">
						<div class="bi-service-feed-item position-relative" >
							<span class="hover_img position-absolute" data-background="{{ asset('assets/surpriseme/category/for-partner.jpg') }}"></span>
							<span class="serial-number position-absolute">06</span>
							<div class="service-icon position-relative">
								<i class="flaticon-design-thinking"></i>
							</div>
							<div class="service-text headline pera-content">
								<h3><a href="#">For Your Partner</a></h3>
								<p>Romantic Delight</p>
								<a class="read_more d-flex justify-content-center align-items-center text-uppercase" href="#"><i class="fas fa-long-arrow-right"></i></a>
							</div>
						</div>
					</div>
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="{{ asset('assets/surpriseme/category/for-partner.jpg') }}">
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="{{ asset('assets/surpriseme/category/birthday.jpg') }}">
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="{{ asset('assets/surpriseme/category/anniversary.jpg') }}">
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="{{ asset('assets/surpriseme/category/couple.jpg') }}">
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="{{ asset('assets/surpriseme/category/celebration.jpg') }}">
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="{{ asset('assets/surpriseme/category/celebration1.jpg') }}">
							</div>
						</div>
						<div class="swiper-slide">
							<div class="bi-sponsor-item">
								<img src="{{ asset('assets/surpriseme/category/celebration3.jpg') }}">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-7">
						<div class="bi-fun-fact-text-area-2">
							<div class="bi-section-title-1 headline pera-content">
								...
								<h3 class="tx-split-text split-in-right">Create memories
									<span class="b-strock-font">with spontaneous plans</span>
								in stunning place.</h3>
							</div>
							<div class="bi-btn-1  bi-btn-area text-uppercase">
								<a class="bi-btn-main bi-btn-hover bi-btn-item" href="#">About</a>
							</div>
						</div>
					</div>
					<div class="col-lg-5">
						<div class="bi-fun-fact-counter-2 position-relative">
							<!--<span class="bi-fun-fact-star position-absolute"><img src="{{ asset('assets/img/icon/star2.png') }}" alt=""></span>-->
							<div class="row">
								<video width="320" height="240" controls>
                                  <source src="{{ asset('assets/surpriseme/category/surprise.mp4') }}" type="video/mp4">
                                </video>
							</div>
						</div>
					</div>
