    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="{{ url('/') }}"><img src="{{ $setting->getFirstMediaUrl('header_logo') }}"
                        alt="tidal"></a>
            </div>
            <div class="th-mobile-menu">
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ url('home_for_sale') }}">Homes for Sale</a></li>
                            <li><a href="{{ url('home_for_rent') }}">Homes to Rent</a></li>
                        </ul>
                    </li>
                    {{-- <li class="menu-item-has-children">
                    ...
                    @if (Auth::check())
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li><a href="{{ url('wishlist') }}" class='users_class ps-0'><i
                                            class="far fa-heart"></i> Wishlist</a></li>
                                <li><a href="{{ route('logout') }}" class='users_class ps-0'
                    ...
                    <li class="menu-item-has-children">
                        <div class="widget widget-search border-0 p-0 container mt-2 mb-0">
                            <form id="search-form" class="search-form" action="{{ url('projects') }}" method="GET">
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-md-3 col-4">
                                <div class="header-logo">
                                    <a href="{{ url('/') }}"><img
                                            src="{{ $setting->getFirstMediaUrl('header_logo') }}" alt="tidal"></a>
                                </div>
                            </div>
                                        ...
                                        <li class="menu-item-has-children">
                                            <div class="widget widget-search border-0 p-0 container mb-0">
                                                <form id="search-form" class="search-form"
                                                    action="{{ url('projects') }}" method="GET">
...
==============================-->
    <footer class="footer-wrapper footer-layout4">
                    ...
                    <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="widget footer-widget">
                            <div class="footer-logo">
                                <a href="{{ url('/') }}"><img
                                        src="{{ $setting->getFirstMediaUrl('footer_logo') }}" alt="Gaia"
                            ...
                            <div class="th-widget-about">
                                ...
                                <div class="th-social">
                                    @if ($setting->facebook)
                                        <a target="_blank" href="{{ $setting->facebook }}"><i
                                                class="fab fa-facebook-f"></i></a>
                                    @endif
                                    @if ($setting->skype)
                                        <a target="_blank" href="{{ $setting->skype }}"><i
                                                class="fab fa-skype"></i></a>
                                    @endif
                                    @if ($setting->twitter)
                                        <a target="_blank" href="{{ $setting->twitter }}"><i
                            ...
                            <div class="menu-all-pages-container">
                                <div class="list-two-column">
                                    <ul class="menu">
                                        ...
                                        <li><a href="{{ url('home_for_sale') }}">Home for Sale</a></li>
                                        <li><a href="{{ url('home_for_rent') }}">Home for Rent</a></li>
                            ...
                            <div class="th-widget-contact">
                                <div class="info-box">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="info-box_text" style="line-height: 25px;">{{ $setting->address }}
                                        </p>
                                    </div>
                                </div>
                                <div class="info-box">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <a href="tel:+1{{ $setting->phone }}" class="info-box_link">+(1)
                                            {{ $setting->phone }}</a>
                                    </div>
                                </div>
                                <div class="info-box">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <a href="mailto:{{ $setting->email }}"
                                            class="info-box_link">{{ $setting->email }}</a>
                                    </div>
                                </div>
                                <div class="info-box">
                                    <div class="info-box_icon">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <a href="#" class="info-box_link">{{ $setting->hours }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="copyright-wrap">
            <div class="container">
                <p class="copyright-text text-center">Copyright By © <a href="{{ url('/') }}">Gaia</a> - 2023
                </p>
            </div>
        </div>
    </footer>
        ...
        const handleChat = () => {
            ...
            fetch('/store-chat-message', {
                ...
                headers: {
                    ...
                    'X-CSRF-TOKEN': '{{ csrf_token() }}', // Ensure to include CSRF token if using Laravel CSRF protection
                },
