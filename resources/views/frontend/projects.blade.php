...
<script>
    ...
    function filter() {
       ...
       $.ajax({ 
            url:"{{ url('projects') }}/?page="+page+"&search="+search+"&home_for="+home_for+"&min_price="+min_price+"&max_price="+max_price+"&home_type="+home_type+"&bads="+bads+"&baths="+baths+"&sqft_min="+sqft_min+"&sqft_max="+sqft_max,
