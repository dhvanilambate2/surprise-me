...
<div class="container pt-4">
    	...
    	<div class="row" id="filter">
			<div class="form-group col-lg-3 col-sm-12">
			       <input type="text" placeholder="Enter an Address" id="search" class="form-control px-2 px-sm-4" name="search" value="{{ (isset($_GET['search']))? $_GET['search'] : '' }}">
			</div>
			    ...
			    <div class="row">
        			...
        			<div class="form-group col-md-2 col-sm-6">
        				<div class="main-menu form-control p-0">
        				    <ul>
        				        <li class="menu-item-has-children w-100 background">
                                    <a class="btn w-100 py-3 ps-2 pe-0">Bads & Baths {{-- <span class="th-mean-expand"></span> --}}</a>
                                    <ul class="sub-menu ">
                                        <li>
                                            <form>
...
<script>
    ...
    function filter() {
       ...
       $.ajax({ 
            url:"{{ url('wishlist') }}/?page="+page+"&search="+search+"&home_for="+home_for+"&min_price="+min_price+"&max_price="+max_price+"&home_type="+home_type+"&bads="+bads+"&baths="+baths+"&sqft_min="+sqft_min+"&sqft_max="+sqft_max,
