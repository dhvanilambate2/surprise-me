...
class oldFrontController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.index',['reviews' => $reviews,'teams' => $teams,'setting' => $setting,'home_details' => $home_details,'team_section' => $teamSectionStatus,'review_section' => $reviewSectionStatus,]);
    }
