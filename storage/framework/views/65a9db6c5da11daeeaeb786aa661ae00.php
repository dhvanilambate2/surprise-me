      ...
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown w-100"> <span class="media user-header"><img class="img-fluid" src="<?php echo e(route('/')); ?>/assets/images/dashboard/user.png" style="width: 100px" alt=""></span>
          <ul class="onhover-show-div profile-dropdown">
            ...
            <li><a href="<?php echo e(url("admin/profile")); ?>"><i data-feather="user"> </i>Profile</a></li>
...
</div><?php /**PATH C:\laragon\www\stage\resources\views/layouts/simple/header.blade.php ENDPATH**/ ?>