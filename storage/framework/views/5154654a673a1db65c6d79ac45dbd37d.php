...
<?php $__env->startSection('breadcrumb-items'); ?>
    ...
    <a href="<?php echo e(route('services.index')); ?>" class="breadcrumb-item">Services Details</a>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <form class="row themeform" method="post" action="<?php echo e(route('services.store')); ?>"
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="sub_title" type="text" placeholder="Enter Sub Title"
                                        name="sub_title" value="<?php echo e(old('sub_title')); ?>">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            ...
                                            <input class="form-control" id="price" type="number"
                                                placeholder="Enter Price" name="price" value="<?php echo e(old('price')); ?>">
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/justdigi/surprise-me.justdigitalgurus.com/resources/views/backend/services/create.blade.php ENDPATH**/ ?>