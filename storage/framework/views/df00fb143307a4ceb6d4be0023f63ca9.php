<?php $__env->startSection('title', 'Edit Home For Sale'); ?>
...
<?php $__env->startSection('breadcrumb-items'); ?>
    ...
    <a href="<?php echo e(route('home_for_rent.index')); ?>" class="breadcrumb-item">Home For Sale</a> 
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <form class="row needs-validation themeform" method="post" action="<?php echo e(Route('home_for_sale.update',$homeDetails->id)); ?>" enctype="multipart/form-data" id="package_form">
                            <?php echo csrf_field(); ?>
...
<script>
    ...
    $(document).ready(function() {
      ...
      // Prevent default form submission
          ...
          // Make AJAX request
          $.ajax({
              url: "<?php echo e(route('home_for_sale.update',$homeDetails->id)); ?>",
              type: 'POST',
              data: formData,
              headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/backend/sale/edit.blade.php ENDPATH**/ ?>