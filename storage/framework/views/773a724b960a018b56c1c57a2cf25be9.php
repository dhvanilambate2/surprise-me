  ...
  ==============================-->
    ...
    <div class="preloader" id="preloader">
        ...
        <div class="preloader-inner">
            <span class="loader"><img src="<?php echo e(url('frontend')); ?>/assets/img/logo.svg" class="img-fluid"></span>
        </div>
    </div>
    ...
    <div class="hero-slider-4 th-carousel" id="heroSlide4" data-fade="false" data-slide-show="1">
        <div>
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-bg-src="<?php echo e(url('frontend')); ?>/assets/img/bg/hero_bg_4_1.jpeg" data-overlay="black" data-opacity="6"></div>
                <div class="container">
                    <div class="hero-style4">
                        ...
                        <a href="<?php echo e(url('home_for_sale')); ?>" class="th-btn" data-ani="slideinup" data-ani-delay="0.7s"><span class="line left"></span> View Projects <span class="line"></span></a>
                    </div>
                </div>
            </div>
        </div>
        <div>
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-bg-src="<?php echo e(url('frontend')); ?>/assets/img/bg/hero_bg_4_2.jpeg" data-overlay="black" data-opacity="6"></div>
                <div class="container">
                    <div class="hero-style4">
        ...
        <!-- <div>
                <div class="th-hero-slide">
                    <div class="th-hero-bg" data-bg-src="<?php echo e(url('frontend')); ?>/assets/img/bg/hero_bg_4_3.jpg" data-overlay="black" data-opacity="6"></div>
                    <div class="container">
                        <div class="hero-style4">
                            <span class="h4 hero-subtitle" data-ani="slideinup" data-ani-delay="0.1s">DESIGN IS MAKING SENSE OF THINGS.</span>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-6 mb-5 mb-xl-0 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="img-box1">
                    <div class="img1">
                        <img src="<?php echo e(url('frontend')); ?>/assets/img/home/about.png" alt="About">
                    </div>
                </div>
            </div>
            <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                ...
                <a href="<?php echo e(url('/')); ?>" class="th-btn"><span class="line left"></span> Why Us <span class="line"></span></a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                <div class="feature-card">
                    <div class="feature-card_icon shape-icon">
                        <img class="svg-img" src="<?php echo e(url('frontend')); ?>/assets/img/icon/feature_card_1.svg" alt="icon">
                    </div>
            ...
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="feature-card">
                    <div class="feature-card_icon shape-icon">
                        <img class="svg-img" src="<?php echo e(url('frontend')); ?>/assets/img/icon/feature_card_2.svg" alt="icon">
                    </div>
            ...
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                <div class="feature-card">
                    <div class="feature-card_icon shape-icon">
                        <img class="svg-img" src="<?php echo e(url('frontend')); ?>/assets/img/icon/feature_card_3.svg" alt="icon">
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-md-between align-items-end">
            ...
            <div class="col-auto mt-n4 mt-lg-0 wow fadeInUp" data-wow-delay="0.3s">
                <div class="sec-btn">
                    <a href="<?php echo e(url('home_for_sale')); ?>" class="link-btn">View The Projects</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="project-slide-wrap">
            <div class="row" id="projectSlide3">
                <?php
                    $count = 01;
                ?>
                <?php $__currentLoopData = $home_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $home_detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-6">
                    <div class="project-card">
                        <div class="project-img">
                        <?php if($home_detail->getFirstMediaUrl('images')): ?>
                            <img src="<?php echo e($home_detail->getFirstMediaUrl('images')); ?>" alt="project image" style="height:410px !important; width:100%">
                        <?php endif; ?>
                        </div>
                        
                        <?php if($home_detail->home_for == 'rent'): ?>
                            <h3 class="h5 project-title"><a href="<?php echo e(route('home_for_rent.details', ['id' => $home_detail->id])); ?>"><?php echo e($home_detail->property_name); ?></a></h3>
                        <?php else: ?> 
                            <h3 class="h5 project-title"><a href="<?php echo e(route('home_for_sale.details', ['id' => $home_detail->id])); ?>"><?php echo e($home_detail->property_name); ?></a></h3>
                        <?php endif; ?>
                        <p class="project-map"><i class="fal fa-location-dot"></i><?php echo e($home_detail->address); ?></p>
                        <?php if($count > 9): ?>
                ...
                <!-- <div class="col-lg-6">
                    <div class="project-card">
                        <div class="project-img">
                            <img src="<?php echo e(url('frontend')); ?>/assets/img/project/project_3_2.jpeg" alt="project image">
                        </div>
                        <h3 class="h5 project-title"><a href="<?php echo e(url('home_for_sale')); ?>">Majestic Horizons</a></h3>
                        <p class="project-map"><i class="fal fa-location-dot"></i>UK</p>
                ...
                <div class="col-lg-6">
                    <div class="project-card">
                        <div class="project-img">
                            <img src="<?php echo e(url('frontend')); ?>/assets/img/project/project_3_3.jpeg" alt="project image">
                        </div>
                        <h3 class="h5 project-title"><a href="<?php echo e(url('home_for_sale')); ?>">Pinnacle Park Plaza</a></h3>
                        <p class="project-map"><i class="fal fa-location-dot"></i>New York</p>
...
<!-- <section class=" ">
        <div class="container">
            <div class="video-counter">
                <div class="th-video">
                    <img src="<?php echo e(url('frontend')); ?>/assets/img/normal/video_1.jpg" alt="video">
            ...
            <div class="service-grid-area">
                ...
                <div class="service-grid-slide">
                    <div class="th-carousel" id="sr-grid" data-slide-show="1" data-md-slide-show="1" data-asnavfor="#sr-list, #sr-img">
                        <div>
                            <div class="service-card style2">
                                <div class="service-card_icon">
                                    <img class="svg-img" src="<?php echo e(url('frontend')); ?>/assets/img/icon/service_1_1.svg" alt="service image">
                                </div>
                        ...
                        <div>
                            <div class="service-card style2">
                                <div class="service-card_icon">
                                    <img class="svg-img" src="<?php echo e(url('frontend')); ?>/assets/img/icon/service_1_2.svg" alt="service image">
                                </div>
                        ...
                        <div>
                            <div class="service-card style2">
                                <div class="service-card_icon">
                                    <img class="svg-img" src="<?php echo e(url('frontend')); ?>/assets/img/icon/service_1_3.svg" alt="service image">
                                </div>
                        ...
                        <div>
                            <div class="service-card style2">
                                <div class="service-card_icon">
                                    <img class="svg-img" src="<?php echo e(url('frontend')); ?>/assets/img/icon/service_1_4.svg" alt="service image">
                                </div>
                        ...
                        <div>
                            <div class="service-card style2">
                                <div class="service-card_icon">
                                    <img class="svg-img" src="<?php echo e(url('frontend')); ?>/assets/img/icon/service_1_5.svg" alt="service image">
                                </div>
                ...
                <div class="service-grid-img">
                    <div class="th-carousel" id="sr-img" data-slide-show="1" data-md-slide-show="1" data-asnavfor="#sr-grid, #sr-list">
                        <div>
                            <div class="img">
                                <img src="<?php echo e(url('frontend')); ?>/assets/img/service/service_1_1.jpg" alt="service Image">
                            </div>
                        </div>
                        <div>
                            <div class="img">
                                <img src="<?php echo e(url('frontend')); ?>/assets/img/service/service_1_2.jpg" alt="service Image">
                            </div>
                        </div>
                        <div>
                            <div class="img">
                                <img src="<?php echo e(url('frontend')); ?>/assets/img/service/service_1_3.jpg" alt="service Image">
                            </div>
                        </div>
                        <div>
                            <div class="img">
                                <img src="<?php echo e(url('frontend')); ?>/assets/img/service/service_1_4.jpg" alt="service Image">
                            </div>
                        </div>
                        <div>
                            <div class="img">
                                <img src="<?php echo e(url('frontend')); ?>/assets/img/service/service_1_5.jpg" alt="service Image">
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="space-bottom">
    <div class="container">
        <h2 class="sec-title text-center mb-4 wow fadeInUp" data-wow-delay="0.2s">Our <span class="text-transparent">Team </span></h2>
        <div class="row th-carousel" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2">
            ...
            <!-- <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-card  ">
                        ...
                        <div class="team-img">
                            <img src="<?php echo e(url('frontend')); ?>/assets/img/team/team_2_5.jpg" alt="Team">
                        </div>
                    </div>
                </div> -->
        </div>
...
<div class="space-bottom">
    <div class="container">
        ...
        <div class="row testi-box-slide th-carousel" data-slide-show="2" data-md-slide-show="1">
            ...
            <div class="col-lg-6">
                <div class="testi-box">
                    <p class="testi-box_text"><?php echo $item->description; ?></p>
                    <div class="testi-box_profile">
                        <div class="testi-box_img">
                            <img src="<?php echo e($item->getFirstMediaUrl('reviews')); ?>" alt="Avater">
                        </div>
                        <div class="testi-box_info">
                            <h3 class="testi-box_name"><?php echo e($item->name); ?></h3>
                            <span class="testi-box_desig"><?php echo e($item->post); ?></span>
                        </div>
                    </div>
                    <div class="testi-box_icon">
                        <img src="<?php echo e($item->getFirstMediaUrl('reviews')); ?>" alt="icon">
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
2s">
                <div class="img-box5">
                    <div class="img1">
                        <img src="<?php echo e(url('frontend')); ?>/assets/img/home/contact.png" alt="contact">
                    </div>
                    <div class="info-card-wrap">
                        <div class="info-card">
                            ...
                            <div class="info-card_content">
                                ...
                                <a href="tel:+12345678900" class="info-card_link text-nowrap">(+1) <?php echo e($setting->phone); ?></a>
                            </div>
                        </div>
                        <div class="info-card">
                            <div class="info-card_icon">
                            ...
                            <div class="info-card_content">
                                ...
                                <a href="mailto:info@gaiahomesfl.com" class="info-card_link text-nowrap fs-5"><?php echo e($setting->email); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-6">
                            <input type="number" class="form-control" name="number" id="number" placeholder="Your Number" value="<?php echo e(old('number')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-6">
                            <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" value="<?php echo e(old('subject')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-12">
                            <input type="email" class="form-control" name="email" id="email" placeholder="Email Address" value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-12">
                            <textarea name="message" id="message" cols="30" rows="3" class="form-control" placeholder="Message"><?php echo e(old('message')); ?></textarea>
        ...
        <div class="container">
            ...
            <div class="row th-carousel" data-slide-show="3" data-lg-slide-show="2" data-md-slide-show="2" data-sm-slide-show="1">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="blog-grid">
                        <div class="blog-img">
                            <img src="<?php echo e(url('frontend')); ?>/assets/img/blog/blog_3_1.jpg" alt="blog image">
                        </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="blog-grid">
                        <div class="blog-img">
                            <img src="<?php echo e(url('frontend')); ?>/assets/img/blog/blog_3_2.jpg" alt="blog image">
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta style2">
                                <a href="blog.html">Architecture</a>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="blog-grid">
                        <div class="blog-img">
                            <img src="<?php echo e(url('frontend')); ?>/assets/img/blog/blog_3_3.jpg" alt="blog image">
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta style2">
                                <a href="blog.html">Architecture</a>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="blog-grid">
                        <div class="blog-img">
                            <img src="<?php echo e(url('frontend')); ?>/assets/img/blog/blog_3_4.jpg" alt="blog image">
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta style2">
                                <a href="blog.html">Architecture</a>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\stage\resources\views/frontend/index.blade.php ENDPATH**/ ?>