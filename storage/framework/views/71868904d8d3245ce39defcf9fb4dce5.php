...
<?php $__env->startSection('breadcrumb-items'); ?>
    ...
    <a href="<?php echo e(route('vendors.index')); ?>" class="breadcrumb-item">Vendor Details</a>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form class="row" method="post" action="<?php echo e(route('vendors.store')); ?>" enctype="multipart/form-data" id="" autocomplete="off">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/justdigi/surprise-me.justdigitalgurus.com/resources/views/backend/vendor/create.blade.php ENDPATH**/ ?>