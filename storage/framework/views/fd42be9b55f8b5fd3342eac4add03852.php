  ...
  ==============================-->
    <div class="preloader" id="preloader">
        ...
        <div class="preloader-inner">
            <span class="loader" style="width: 250px !important;"><img src="<?php echo e($setting->getFirstMediaUrl('loader_image')); ?>" class="img-fluid"></span>
        </div>
    </div>
            ...
            <div class="th-hero-slide">
                ...
                <div class="container">
                    <div class="hero-style4">
                        ...
                        <a href="<?php echo e(url('projects')); ?>" class="th-btn" data-ani="slideinup" data-ani-delay="0.7s"><span class="line left"></span> View Projects <span class="line"></span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-md-between align-items-end">
            ...
            <div class="col-auto mt-n4 mt-lg-0 wow fadeInUp" data-wow-delay="0.3s">
                <div class="sec-btn">
                    <a href="<?php echo e(url('projects')); ?>" class="link-btn">View The Projects</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="project-card">
                        ...
                        <?php if($home_detail->getFirstMediaUrl('images')): ?>
                            <?php if($home_detail->home_for == 'rent'): ?>
                                <a href="<?php echo e(route('home_for_rent.details', ['id' => $home_detail->id])); ?>">
                                    <img src="<?php echo e($home_detail->getFirstMediaUrl('images')); ?>" alt="project image" style="height:410px !important; width:100%">
                                </a>
                            <?php else: ?> 
                                <a href="<?php echo e(route('home_for_sale.details', ['id' => $home_detail->id])); ?>">
                                    <img src="<?php echo e($home_detail->getFirstMediaUrl('images')); ?>" alt="project image" style="height:410px !important; width:100%">
                                </a>
                            <?php endif; ?>
...
<section class="space-bottom">
    <div class="container">
        <div class="row justify-content-md-between align-items-end">
            ...
            <div class="col-auto mt-n4 mt-lg-0 wow fadeInUp" data-wow-delay="0.3s">
                <div class="sec-btn">
                    <a href="<?php echo e(url('teams')); ?>" class="link-btn">Show More</a>
                </div>
            </div>
        </div>
    </div>
...
Testimonial Area  
==============================-->
<?php if($review_section->status == 1): ?>
...
2s">
            ...
            <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <form class="needs-validation" novalidate action="<?php echo e(route('contact.store')); ?>" method="POST" class="contact-form">
                <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <input type="text" class="form-control" name="subject" id="subject" maxlength="200" placeholder="Subject" value="<?php echo e(old('subject')); ?>" required>
                            <div class="invalid-feedback">
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/frontend/index.blade.php ENDPATH**/ ?>