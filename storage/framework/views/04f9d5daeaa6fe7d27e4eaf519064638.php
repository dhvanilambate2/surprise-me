...
<div class="">
        <div class="breadcumb-wrapper  mt-4 d-flex align-items-center flex-column " data-bg-src="<?php echo e(url('frontend')); ?>/assets/img/bg/all-page.png">
            <h1 class="breadcumb-title">Home For Rent</h1>
            <div class="widget widget-search border-0 w-50 container d-none">
                <form id="search-form" class="search-form">
                    <input type="text" class="form-control" name="general_search" id="general_search" placeholder="">
...
<div class="container pt-4">
    	...
    	<div class="row" id="filter">
			<div class="form-group col-lg-3 col-sm-12">
			       ...
			       <select class="filter-type filter form-control d-none" id="homeFor" name="home_for">
			    ...
			    <div class="row">
        			...
        			<div class="form-group col-md-2 col-sm-6">
        				<div class="main-menu form-control p-0">
        				    <ul>
        				        <li class="menu-item-has-children w-100 background">
                                    <a class="btn w-100 py-3 ps-2 pe-0">Beds & Baths </a>
                                    <ul class="sub-menu ">
                                        <li>
                                            <form>
        			...
        			<div class="form-group col-md-2 col-sm-6">
        				<button type="button" id="apply_btn" class="th-btn w-100">Search</button>
        			</div>
...
<script>
    ...
    function filter() {
       ...
       $.ajax({ 
            url:"<?php echo e(url('home_for_rent')); ?>/?page="+page+"&search="+search+"&home_for="+home_for+"&min_price="+min_price+"&max_price="+max_price+"&home_type="+home_type+"&bads="+bads+"&baths="+baths+"&sqft_min="+sqft_min+"&sqft_max="+sqft_max,
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/frontend/home_for_rent.blade.php ENDPATH**/ ?>