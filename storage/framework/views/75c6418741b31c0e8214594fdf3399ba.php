      ...
      <div class="col-sm-12">
         <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
               ...
               <a href="<?php echo e(route('categories.create')); ?>"><button class="btn btn-primary btn-sm ">Add Category</button></a>
               <?php endif; ?>
            </div>
               ...
               <table class="table">
                  <thead>
                     <tr>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['categories-edit', 'categories-delete'])): ?>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categories-edit')): ?>
                              ...
                              <a href="<?php echo e(route('categories.edit', $item->id)); ?>"><button class="btn btn-shadow-primary btn-sm">Edit </button></a>
                              <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/justdigi/surprise-me.justdigitalgurus.com/resources/views/backend/category/index.blade.php ENDPATH**/ ?>