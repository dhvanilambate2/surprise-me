                ...
                <ul>
                    ...
                    <?php if(Auth::check()): ?>
                       <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li><a href="<?php echo e(url('wishlist')); ?>" class='users_class ps-0'><i class="far fa-heart"></i> Wishlist</a></li>
                                <li><a href="<?php echo e(route('logout')); ?>" class='users_class ps-0' onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i> Logout</a>
                     ...
                     <li class="menu-item-has-children">
                        <div class="widget widget-search border-0 p-0 container mt-2 mb-0">
                            <form id="search-form" class="search-form" action="<?php echo e(url('projects')); ?>" method="GET">
                                <input type="text" class="form-control" name="search" id="general_search" placeholder="Search an Address">
                        ...
                        <div class="th-widget-contact">
                            <div class="info-box">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="info-box_text" style="line-height: 25px;"><?php echo e($setting->address); ?></p>
                                </div>
                            </div>
                            <div class="info-box">
                                <div class="info-box_icon">
...
<?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/frontend/layout/app.blade.php ENDPATH**/ ?>