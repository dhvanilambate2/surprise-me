<?php $__env->startSection('title', 'Add Client Review'); ?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <?php endif; ?>
                        <form class="row needs-validation themeform" method="post" action="<?php echo e(route('setting_home.review_store')); ?>"
    ...
    var images = [];
        ...
        $(document).ready(function() {
            ...
            $('#form_submit_button').click(function (event) {
              ...
              // Make AJAX request
              $.ajax({
                  url: "<?php echo e(route('setting_home.review_store')); ?>",
                  type: 'POST',
                  data: formData,
                  cache: false,
                  contentType: false,
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/backend/setting/home/review_create.blade.php ENDPATH**/ ?>