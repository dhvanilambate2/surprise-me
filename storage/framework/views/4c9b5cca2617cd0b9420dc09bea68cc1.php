				...
				<div class="bi-header-main-navigation">
					<nav class="main-navigation clearfix ul-li">
						<ul id="main-nav" class="nav navbar-nav clearfix">
							...
							<li><a href="<?php echo e(route('vendor')); ?>">Vendor</a></li>
							<li class="dropdown">
								<a href="<?php echo e(route('product-listing')); ?>">Product Listing</a>
...
<!-- End of header section--><?php /**PATH /home3/justdigi/surprise-me.justdigitalgurus.com/resources/views/frontend/layouts/header.blade.php ENDPATH**/ ?>