            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <?php endif; ?>
                        <form class="row needs-validation themeform" method="post" action="<?php echo e(route('setting_home.team_update',$teams->id)); ?>"
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="name" type="text" placeholder="Enter Name"
                                        name="name" value="<?php echo e(old('name', $teams->name)); ?>">
                                    <span class="text-danger" id="name-error"></span>
                                </div>
                                <div class="form-group">
                                    <label for="post">Post</label>
                                    <input class="form-control" id="post" type="text" placeholder="Enter Post"
                                        name="post" value="<?php echo e(old('post',$teams->post)); ?>">
                                    <span class="text-danger" id="post-error"></span>
                                </div>
                                <div class="form-group">
                                    <label for="description">Description:</label>
                                    <textarea id="description" class="rounded" name="description"><?php echo e(old('description', $teams->description)); ?></textarea>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="facebook" type="url"
                                                ...
                                                value="<?php echo e(old('facebook', $teams->facebook)); ?>">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="skype" type="url"
                                                ...
                                                value="<?php echo e(old('skype',$teams->skype)); ?>">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="twitter" type="url"
                                                ...
                                                value="<?php echo e(old('twitter',$teams->twitter)); ?>">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div id="imagePreviewContainer" >
                                    <?php if($teams->hasMedia('teams')): ?>
                                        <div class="d-flex mb-3">
                                            <?php $__currentLoopData = $teams->getMedia('teams'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    var images = [];
        ...
        $(document).ready(function() {
            ...
            $('#form_submit_button').click(function (event) {
              ...
              // Make AJAX request
              $.ajax({
                  url: "<?php echo e(route('setting_home.team_update', $teams->id)); ?>",
                  type: 'POST',
                  data: formData,
                  cache: false,
                  contentType: false,
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/backend/setting/home/team_edit.blade.php ENDPATH**/ ?>