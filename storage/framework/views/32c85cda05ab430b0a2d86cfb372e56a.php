...
<?php $__env->startSection('breadcrumb-items'); ?>
    ...
    <a href="<?php echo e(route('vendor_shop.index')); ?>" class="breadcrumb-item">Services Details</a>
                ...
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <form class="row needs-validation themeform" method="post"
                            action="<?php echo e(Route('services.update', $services->id)); ?>" enctype="multipart/form-data"
                            id="package_form">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="service_name" type="text"
                                        ...
                                        value="<?php echo e(old('service_name', $services->service_name)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="sub_title" type="text" placeholder="Enter Sub Title"
                                        name="sub_title" value="<?php echo e(old('sub_title', $services->sub_title)); ?>">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            ...
                                            <input class="form-control" id="price" type="number"
                                                placeholder="Enter Price" name="price" value="<?php echo e(old('price', $services->price)); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <select name="category" id="category" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>"
                                                <?php echo e(old('category', $services->category_id) == $category->id ? 'selected' : ''); ?>>
                                    ...
                                    <select name="vendor" id="vendor" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($vendor->id); ?>"
                                                <?php echo e(old('vendor', $services->vendor_id) == $vendor->id ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" rows="4" class="form-control" name="description" placeholder="Enter a Description"><?php echo old('description', $services->description); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Embed Map Here" name="location"
                                        value="<?php echo e(old('location', $services->location)); ?>">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $__currentLoopData = $services->getMedia('front_image'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <?php $__currentLoopData = $services->getMedia('service_images'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="d-flex flex-column">
                                                <img src="<?php echo e($image->getUrl()); ?>" alt="<?php echo e($image->name); ?>"
                                                    style="height: 100px;width: 100px;">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#form_submit_button').click(function(event) {
                ...
                // Make AJAX request
                $.ajax({
                    url: "<?php echo e(route('services.update', $services->id)); ?>",
                    type: 'POST',
                    data: formData,
                    headers: {
                    ...
                    success: function(data) {
                        ...
                        if (data.success) {
                            window.location = "<?php echo e(URL::to('/admin/services')); ?>";
                        }
                    },
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/justdigi/surprise-me.justdigitalgurus.com/resources/views/backend/services/edit.blade.php ENDPATH**/ ?>