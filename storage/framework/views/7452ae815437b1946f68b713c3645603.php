...
<a href="<?php echo e(route('blog_categories.index')); ?>" class="breadcrumb-item">Blog Categories</a>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <?php endif; ?>
                        <form class="row needs-validation themeform"  method="post" action="<?php echo e(route('blog_categories.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="name" type="text"
                                        placeholder="Enter Category Name" name="name" value="<?php echo e(old('name')); ?>">
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/backend/blog_category/create.blade.php ENDPATH**/ ?>