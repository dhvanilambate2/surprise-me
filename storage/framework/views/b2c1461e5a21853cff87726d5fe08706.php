            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <?php endif; ?>
                        <form class="row needs-validation themeform"  method="post" action="<?php echo e(route('blogs.store')); ?>" enctype="multipart/form-data" id="package_form">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="title" type="text"
                                        placeholder="Enter Title" name="title" value="<?php echo e(old('title')); ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="blog_category" id="blog_category" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $blog_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>" <?php echo e((old('blog_category'))? 'selected' : ''); ?>><?php echo e($item->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="content" rows="4" class="form-control" placeholder="Enter a Content" name="content" required><?php echo e(old('content')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/backend/blog/create.blade.php ENDPATH**/ ?>