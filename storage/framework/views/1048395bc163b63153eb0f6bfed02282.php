...
<div class="py-4">
    <div class="container">
        <div class="row gy-30" id="homeData"> <!-- id="homeData" -->
            <?php echo $__env->make('frontend/wishlistData', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    function filter() {
       ...
       $.ajax({ 
            url:"<?php echo e(url('wishlist')); ?>/?page="+page+"&search="+search+"&home_for="+home_for+"&min_price="+min_price+"&max_price="+max_price+"&home_type="+home_type+"&bads="+bads+"&baths="+baths+"&sqft_min="+sqft_min+"&sqft_max="+sqft_max,
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/frontend/wishlist.blade.php ENDPATH**/ ?>