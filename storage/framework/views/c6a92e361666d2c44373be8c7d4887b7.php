...
<?php $__env->startSection('title', 'Chat Details'); ?>
    ...
    <script>
        ...
        const fetchChats = async () => {
            // try {
                const response = await $.ajax({
                    url: "<?php echo e(route('fetch.admin.chats')); ?>",
                    type: "GET",
                    data: {
                        user_id: $('#user_id').val()
                    }
                ...
                $.ajax({
                    url: '<?php echo e(route("fetch.chat.users")); ?>',
                    type: 'GET',
                    success: function(response) {
        ...
        $(document).ready(function() {
            ...
            $('#chat-submit').click(function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("chat.store")); ?>',
                    type: 'POST',
                    data: {
            ...
            function changeStatus(userId) {
                $.ajax({
                    url: '<?php echo e(route("update.chat.status")); ?>',
                    type: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        user_id: userId
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\raj\gaia\resources\views/backend/chat/index.blade.php ENDPATH**/ ?>