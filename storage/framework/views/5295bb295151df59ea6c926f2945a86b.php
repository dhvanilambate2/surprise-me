<?php $__env->startSection('title', 'Vendors Details'); ?>
...
<?php $__env->startSection('breadcrumb-title'); ?>
    <h2>Data of <span>Vendors</span></h2>
<?php $__env->stopSection(); ?>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vendors-create')): ?>
                            <a href="<?=route('vendors.create')?>"><button class="btn btn-primary btn-sm ">Add Vendor</button></a>
                        <?php endif; ?>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vendors-edit')): ?>
                                                    <a href="<?php echo e(route('vendors.edit', $item->id)); ?>"><button class="btn btn-shadow-primary btn-sm">Edit </button></a>
                                                    <?php endif; ?>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="<?php echo e(route('vendors.destroy', $item->id)); ?>" method="POST">
                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/justdigi/surprise-me.justdigitalgurus.com/resources/views/backend/vendor/index.blade.php ENDPATH**/ ?>