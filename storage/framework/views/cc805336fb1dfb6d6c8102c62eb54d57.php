<?php $__env->startSection('title', 'Edit Vendor shop'); ?>
...
<?php $__env->startSection('breadcrumb-items'); ?>
    ...
    <a href="<?php echo e(route('vendor_shop.index')); ?>" class="breadcrumb-item">Vendor Shop Details</a>
    <li class="breadcrumb-item active">Edit Shop Details</li>
<?php $__env->stopSection(); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <form class="row needs-validation themeform" method="post"
                            action="<?php echo e(Route('vendor_shop.update', $VendorShop->id)); ?>" enctype="multipart/form-data"
                            id="package_form">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="shop_name">Name Of Shop:</label>
                                    <input class="form-control" id="shop_name" type="text"
                                        placeholder="Enter Name of Shop" name="shop_name"
                                        value="<?php echo e(old('shop_name', $VendorShop->shop_name)); ?>">
                                    ...
                                    <select name="category" id="category" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>"
                                                <?php echo e((old('category', $VendorShop->category_id) == $category->id) ? 'selected' : ''); ?>>
                                    ...
                                    <select name="vendor" id="vendor" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($vendor->id); ?>"
                                                <?php echo e((old('vendor', $VendorShop->vendor_id) == $vendor->id) ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="phone" type="text"
                                        ...
                                        value="<?php echo e(old('phone', $VendorShop->phone)); ?>">
                                    <span class="text-danger" id="phone-error"></span>
                                </div>
                                <div class="form-group">
                                    <label>Address:</label>
                                    <textarea id="address" name="address" rows="4" placeholder="Enter a Address" class="form-control" required><?php echo e(old('address', $VendorShop->address)); ?></textarea>
                                    <span class="text-danger" id="address-error"></span>
                                </div>

                                <div class="form-group">
                                    <label for="description">Description:</label>
                                    <textarea id="description" rows="4" class="form-control" name="description" placeholder="Enter a Description"><?php echo old('description', $VendorShop->description); ?></textarea>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?php $__currentLoopData = $VendorShop->getMedia('logo_image'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <?php $__currentLoopData = $VendorShop->getMedia('images'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="d-flex flex-column">
                                                <img src="<?php echo e($image->getUrl()); ?>" alt="<?php echo e($image->name); ?>"
                                                    style="height: 100px;width: 100px;">
                                                <a href="javascript:void(0);" class="text-center remove-image"
                                                    data-image-id="<?php echo e($image->id); ?>">Remove</a>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <div class="" id='image_lists'>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#form_submit_button').click(function(event) {
                ...
                // Make AJAX request
                $.ajax({
                    url: "<?php echo e(route('vendor_shop.update', $VendorShop->id)); ?>",
                    type: 'POST',
                    data: formData,
                    headers: {
                    ...
                    success: function(data) {
                        ...
                        if (data.success) {
                            window.location = "<?php echo e(URL::to('/admin/vendor_shop')); ?>";
                        }
                    },
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/justdigi/surprise-me.justdigitalgurus.com/resources/views/backend/vendor_shop/edit.blade.php ENDPATH**/ ?>