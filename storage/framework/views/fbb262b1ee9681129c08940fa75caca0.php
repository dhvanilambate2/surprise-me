<?php $__env->startSection('title', 'Add Vendor shop'); ?>
...
<?php $__env->startSection('breadcrumb-title'); ?>
    <h2>Add<span>Shop details</span></h2>
<?php $__env->stopSection(); ?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        <form class="row themeform" method="post" action="<?php echo e(route('vendor_shop.store')); ?>" enctype="multipart/form-data" id="package_form">
                            <?php echo csrf_field(); ?>

                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="shop_name">Name Of Shop:</label>
                                    <input class="form-control" id="shop_name" type="text" placeholder="Enter Name of Shop" name="shop_name" value="<?php echo e(old('shop_name')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="phone" type="text" placeholder="Enter Phone Number" name="phone" value="<?php echo e(old('phone')); ?>">
                            ...
                            <div class="col-sm-4">
                               <div class="form-group">
                                    <label>Logo Image: ( 810 X 400 )</label>
        ...
        Dropzone.options.mainImageDropzone = {
         ...
         $(document).ready(function() {
          ...
          // Prevent default form submission
              ...
              // Make AJAX request
              $.ajax({
                  url: "<?php echo e(route('vendor_shop.store')); ?>",
                  type: 'POST',
                  data: formData,
                  cache: false,
                  contentType: false,
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/justdigi/surprise-me.justdigitalgurus.com/resources/views/backend/vendor_shop/create.blade.php ENDPATH**/ ?>