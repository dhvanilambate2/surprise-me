 ...
 <div class="table-responsive">
            ...
            <?php $__currentLoopData = $inquiriesDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <?php if($currentTab != "contact"): ?>
                    <td class=""><?php echo e($item->HomeDetails->property_name); ?></td>
                    <?php endif; ?>
...
<script>
    feather.replace();
</script><?php /**PATH C:\laragon\www\stage\resources\views/backend/inquiries/table_content.blade.php ENDPATH**/ ?>