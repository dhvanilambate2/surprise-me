				...
				<div class="bi-header-main-navigation">
					<nav class="main-navigation clearfix ul-li">
						<ul id="main-nav" class="nav navbar-nav clearfix">
							...
							<li><a href="<?php echo e(url('vendor')); ?>">Vendor</a></li>
							<li class="dropdown">
								<a href="<?php echo e(url('product-listing')); ?>">Product Listing</a>
				...
				<div class="bi-header-cta-btn-grp d-flex align-items-center">
					...
					<div class="cta-btn-area">
						<div class="bi-btn-2  bi-btn-area text-uppercase">
							<a class="bi-btn-main  bi-btn-hover bi-btn-item" href="<?php echo e(url('contact')); ?>">  <span></span> Request a Quote</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="mobile_menu_content">
						...
						<nav class="mobile-main-navigation  clearfix ul-li">
							...
							<li class="dropdown">
								<a href="<?php echo e(url('product-listing')); ?>">Product Listing</a>
								<ul class="dropdown-menu clearfix">
									<li><a href="service.html">Product Listing</a></li>
									<!--<li class="dropdown">-->
									<!--	<a href="service-single.html">Product Listing</a>-->
									<!--	<ul class="dropdown-menu clearfix">-->
									<!--		<li><a href="service-single.html" target="_blank">Brand & Art</a></li>-->
...
<!-- End of header section--><?php /**PATH /home3/justdigi/surprise-me.justdigitalgurus.com/resources/views/frontend/layouts/header1.blade.php ENDPATH**/ ?>