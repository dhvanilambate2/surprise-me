                ...
                <tr>
                    ...
                    <td class="truncate-text">
                        ...
                        <select class="form-control form-control-sm"
                            ...
                            <option value="rented" <?php echo e($item->status == 'rented' ? 'selected' : ''); ?>>Rented</option>
                    ...
                    <td class="text-center">
                        ...
                        <input class="current-project-checkbox" onchange="updateCurrentProject(this, <?php echo e($item->id); ?>, this.checked)" id="<?php echo e($item->id); ?>"  type="checkbox" <?php echo e(($item->current_project == '1')? "checked" : ''); ?>>
                    </td>
                    <?php endif; ?>

                    <td class="text-nowrap">
                            <a href="<?php echo e(route('home_for_rent.details', ['id' => $item->id])); ?>" target="_blank"><button class="btn btn-shadow-secondary btn-sm px-3">Preview </button></a>
                            <a href="<?php echo e(route('home_for_rent.edit', $item->id)); ?>"><button class="btn btn-shadow-primary btn-sm">Edit </button></a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="<?php echo e(route('home_for_rent.destroy', $item->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
...
<script>
    feather.replace();
</script><?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/backend/rent/table_content.blade.php ENDPATH**/ ?>