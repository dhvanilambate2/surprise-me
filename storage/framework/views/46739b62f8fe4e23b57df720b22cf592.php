   ...
   <div class="sidebar">
      <ul class="iconMenu-bar custom-scrollbar">
         ...
         <li>
            ...
            <ul class="iconbar-mainmenu custom-scrollbar">
               <li class="iconbar-header">Manage Homes</li>
               ...
               <li><a href="<?php echo e(url('admin/home/create')); ?>">Add Home</a></li> 
               <!--<li class="iconbar-header sub-header">Manage Gallery</li>-->
         ...
         <!--</li>-->
               ...
               <li>
                  <a class="bar-icons" href="#"><i class="pe-7s-chat"></i><span>Inquiries</span></a>
                  <ul class="iconbar-mainmenu custom-scrollbar">
                     <li class="iconbar-header">Manage Inquiries</li>
                     <li><a href="<?php echo e(route('inquiries.index')); ?>">Inquiries Details</a></li>
                  </ul>
               </li>
               <?php endif; ?>
           <li>
...
</div><?php /**PATH /home/u492634275/domains/gaiahomesfl.com/public_html/stage/resources/views/layouts/simple/sidebar.blade.php ENDPATH**/ ?>