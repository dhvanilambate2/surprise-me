<?php $__env->startSection('title', 'Home For Sale'); ?>
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="d-flex justify-content-between align-items-center">
               <h5>Home For Sale </h5>
               <a href="<?= route('home_for_sale.create') ?>"><button class="btn btn-primary btn-sm ">Add Home for Sale</button></a>
            </div>
...
function updateCurrentProject(selectElement, itemId, isChecked)
{
    ...
    // Make an Ajax call
    $.ajax({
        url: '<?php echo e(route("home_for_sale.update_current_project")); ?>',  // Replace with your actual route
        method: 'POST',
        data: {
            _token: csrfToken, 
            id: itemId,
...
<script>
    function loadData(tab) {
        ...
        $.ajax({
            url: '<?php echo e(route("get_home_sale_details")); ?>',
            method: 'GET',
...
<script>
  function updateStatus(selectElement, itemId) {
    ...
    $.ajax({
        url: "<?php echo e(route('home_for_sale.update_status', ['id' => '__itemId__'])); ?>".replace('__itemId__', itemId),
        method: 'POST',
        data: {
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\stage\resources\views/backend/sale/index.blade.php ENDPATH**/ ?>